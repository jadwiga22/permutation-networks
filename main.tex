...
Zauważmy, że żeby zrealizować przesunięcie cykliczne o $k$ wystarczy złożyć sieci realizujące przesunięcia o każdą potęgę dwójki.
Rozważmy zapis binarny liczby $k$. Jeżeli na $i$--tej pozycji  występuje $1$, to włączamy sieć, która realizuje przesunięcie cykliczne o $2^i$. Dzięki lematowi \ref{lem:perm_shifty} wiemy, jak stworzyć sieć, która realizuje przesunięcie cykliczne i identyczność i właśnie takiej potrzebujemy. Każda z tych sieci ma $O(n)$ przełączników. My potrzebujmy $\log n$ takich sieci więc nasza sieć będzie miała $O(n \log n)$ przełączników.
