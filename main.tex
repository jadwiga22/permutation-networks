...
\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=0.5cm,y=0.5cm]
\clip(-1.,0.) rectangle (9.,9.);
\draw [line width=1.pt] (0.,1.)-- (8.,1.);
\draw [line width=1.pt] (0.,3.)-- (1.,3.);
\draw [line width=1.pt] (0.,5.)-- (1.,5.);
\draw [line width=1.pt] (0.,7.)-- (3.,7.);
\draw [line width=1.pt] (3.,8.)-- (3.,4.);
\draw [line width=1.pt] (3.,4.)-- (5.,4.);
\draw [line width=1.pt] (5.,4.)-- (5.,8.);
\draw [line width=1.pt] (5.,8.)-- (3.,8.);
\draw [line width=1.pt] (1.,5.)-- (2.,3.);
\draw [line width=1.pt] (1.,3.)-- (2.,5.);
\draw [line width=1.pt] (2.,5.)-- (3.,5.);
\draw [line width=1.pt] (2.,3.)-- (6.,3.);
\draw [line width=1.pt] (5.,5.)-- (6.,5.);
\draw [line width=1.pt] (5.,7.)-- (8.,7.);
\draw [line width=1.pt] (6.,5.)-- (7.,3.);
\draw [line width=1.pt] (6.,3.)-- (7.,5.);
\draw [line width=1.pt] (7.,5.)-- (8.,5.);
\draw [line width=1.pt] (7.,3.)-- (8.,3.);
\draw (0.25,7.5) node {0};
\draw (0.25,5.5) node {1};
\draw (0.25,3.5) node {2};
\draw (0.25,1.5) node {3};

\draw (7.75,7.5) node {0};
\draw (7.75,5.5) node {1};
\draw (7.75,3.5) node {2};
\draw (7.75,1.5) node {3};
\end{tikzpicture}
...
\begin{center}
\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=0.5cm,y=0.5cm]
\clip(-1.,0.) rectangle (15.,9.);
\draw [line width=1.pt] (0.,1.)-- (1.,1.);
\draw [line width=1.pt] (0.,3.)-- (1.,3.);
\draw [line width=1.pt] (0.,5.)-- (1.,5.);
\draw [line width=1.pt] (0.,7.)-- (1.,7.);
\draw [line width=1.pt] (1.,1.)-- (2.,3.);
\draw [line width=1.pt] (1.,3.)-- (2.,1.);
\draw [line width=1.pt] (2.,3.)-- (3.,3.);
\draw [line width=1.pt] (1.,5.)-- (3.,5.);
\draw [line width=1.pt] (1.,7.)-- (3.,7.);
\draw [line width=1.pt] (3.,6.)-- (3.,2.);
\draw [line width=1.pt] (3.,2.)-- (5.,2.);
\draw [line width=1.pt] (5.,2.)-- (5.,6.);
\draw [line width=1.pt] (5.,6.)-- (3.,6.);
\draw [line width=1.pt] (2.,1.)-- (6.,1.);
\draw [line width=1.pt] (5.,3.)-- (6.,3.);
\draw [line width=1.pt] (5.,5.)-- (6.,5.);
\draw [line width=1.pt] (3.,7.)-- (6.,7.);
\draw [line width=1.pt] (6.,3.)-- (7.,1.);
\draw [line width=1.pt] (6.,1.)-- (7.,3.);
\draw [line width=1.pt] (7.,3.)-- (8.,5.);
\draw [line width=1.pt] (8.,5.)-- (9.,5.);
\draw [line width=1.pt] (9.,4.)-- (11.,4.);
\draw [line width=1.pt] (11.,4.)-- (11.,8.);
\draw [line width=1.pt] (11.,8.)-- (9.,8.);
\draw [line width=1.pt] (9.,8.)-- (9.,4.);
\draw [line width=1.pt] (6.,7.)-- (9.,7.);
\draw [line width=1.pt] (11.,7.)-- (14.,7.);
\draw [line width=1.pt] (11.,5.)-- (12.,5.);
\draw [line width=1.pt] (6.,5.)-- (7.,5.);
\draw [line width=1.pt] (7.,5.)-- (8.,3.);
\draw [line width=1.pt] (8.,3.)-- (12.,3.);
\draw [line width=1.pt] (7.,1.)-- (14.,1.);
\draw [line width=1.pt] (12.,5.)-- (13.,3.);
\draw [line width=1.pt] (12.,3.)-- (13.,5.);
\draw [line width=1.pt] (13.,5.)-- (14.,5.);
\draw [line width=1.pt] (13.,3.)-- (14.,3.);
\draw (0.25,7.5) node {0};
\draw (0.25,5.5) node {1};
\draw (0.25,3.5) node {2};
\draw (0.25,1.5) node {3};

\draw (13.75,7.5) node {0};
\draw (13.75,5.5) node {1};
\draw (13.75,3.5) node {2};
\draw (13.75,1.5) node {3};
\end{tikzpicture}
